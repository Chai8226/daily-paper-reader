...
tags: ["query:q4"]
score: 7.0
evidence: 异构机器人的分布式安全导航与避障
tldr: 针对异构多机器人系统在去中心化导航中因动力学差异导致的安全性与效率冲突，本文提出CA-HCBF框架。该框架通过规范化变换统一了不同动力学模型，并引入基于支持函数的方向能力指标，实现了按机器人运动能力动态分配避障责任。实验证明，该方法在保证安全性的同时提升了任务效率，有效解决了异构系统中的死锁和约束冲突问题。
source: arxiv
...
motivation: 现有的去中心化避障方法多假设机器人同质，导致异构机器人在面对统一安全要求时可能因物理能力不足而发生碰撞或死锁。
method: 提出CA-HCBF框架，利用规范化变换统一异构动力学，并根据机器人实时运动能力动态分配避障责任，结合裁剪机制确保约束的可行性。
result: 仿真和物理实验表明，该方法在包含30个异构机器人的复杂场景中，其安全性、任务效率和可行性均优于现有基准方法。
conclusion: 该研究为异构多机器人系统提供了一种具备能力感知和责任公平分配的去中心化安全导航方案，具有较强的实际应用价值。
---
